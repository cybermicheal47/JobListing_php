    ...
    <header class="bg-blue-900 text-white p-4">
      ...
      <?php if (Session::has('user')) : ?>
        <div class="flex justify-between items-center gap-4">
          ...
          <a href="/listings/create" class="bg-white-500 hover:bg-yellow-600 text-black px-4 py-2 rounded hover:shadow-md transition duration-300"><i class="fa fa-edit"></i> Create</a>
        </div>
      <?php else : ?>
